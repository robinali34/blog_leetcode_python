...
{% raw %}
Welcome to the Heap templates page! Here you'll find battle-tested Python snippets for every common heap (priority queue) pattern on LeetCode — from basic min/max heaps to advanced techniques like K-way merge, Two Heaps for medians, and Dijkstra's shortest path. Each section is self-contained so you can copy-paste directly into your solutions. See also [Data Structures](/posts/2025-10-29-leetcode-templates-data-structures/) for related patterns.
